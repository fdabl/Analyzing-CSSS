...
generate_csss_network_df <- function(df, iter, colorByDisc = FALSE, colorEdges = FALSE){
...
graph_network(generate_csss_network_df(df = clean_all, iter = "2018.Santa Fe", colorByDisc = TRUE, colorEdges = TRUE))
