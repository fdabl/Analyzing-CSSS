...
custom.html <- '<div class = "row"><div class = "col-md-8">\n```{r echo=FALSE, fig.align="center",fig.height=4.7}\ncsss.graph\n```\n</div><div class = "col-md-4"><br><br><img src="C:/Users/krfur/Documents/Analyzing-CSSS/img/CSSS_networks_legend.png"></img></div></div>'
...
for (i in 2:length(iter.list)){
  ...
  #webshot2::webshot(html_name, file = paste0(filebasepath, filename.list[i]),
